...
export default function Accueil() {
    return (
        <>
            <section id="Accueil" className="relative bg-slate-950 text-white min-h-screen flex items-center justify-center">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl font-semibold mb-6 text-slate-300">
                            <Typewriter
                                words={['Développeur Web', 'Passionné par le code', 'Toujours en apprentissage']}
                                loop={0}
                                cursor
                                cursorStyle="|"
                                typeSpeed={70}
                        ...
                        <p className="text-lg md:text-xl text-slate-400 mb-8">
                            Bienvenue sur mon portfolio ! Découvrez mes projets, compétences et expériences en développement web.   
                        </p>
                        <a
                            href="#Projects"
